...
def planUpdate():
    ...
    os.system('echo "0 {} * * * bash <(curl -L -s https://raw.githubusercontent.com/malinrruwan/multi-v2ray/master/go.sh) {}| tee -a /root/{}Update.log && v2ray-util restart" >> crontab.txt'.format(local_time,"-x" if run_type == "xray" else "",run_type))
